...
import {
  ...
  type IntervalCalibrationReport,
...
assert.equal(report.schemaVersion, "interval-calibration-simulation-v1");
...
const recomputed = runIntervalCalibrationSimulation(
