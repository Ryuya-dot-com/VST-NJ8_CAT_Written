...
import {
  ...
  type SelectionAdjustedFeasibilityReport,
...
) as SelectionAdjustedFeasibilityReport;
...
assert.equal(report.schemaVersion, "selection-adjusted-feasibility-v1");
...
const recomputed = runSelectionAdjustedFeasibility(
