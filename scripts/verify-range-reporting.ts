...
import {
  ...
  type RangeReportingSimulationReport,
...
) as RangeReportingSimulationReport;
...
assert.equal(report.schemaVersion, "range-reporting-simulation-v1");
...
const recomputed = runRangeReportingSimulation(
