...
import {
  ...
  type SelectionAdjustedImportanceReport,
...
) as SelectionAdjustedImportanceReport;
...
assert.equal(
  ...
  "selection-adjusted-importance-validation-v1"
);
...
const recomputed = runSelectionAdjustedImportanceValidation(
