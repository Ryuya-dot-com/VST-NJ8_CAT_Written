...
import {
  runSelectiveReportingSimulation,
  type SelectiveReportingProvenance,
...
const plan = JSON.parse(planBytes.toString("utf8")) as SelectiveReportingPlan;
const sourcePaths = [
  "scripts/simulate-selective-reporting.ts",
  "src/utils/selectiveReportingSimulation.ts",
  "src/utils/selectiveReportingPlan.ts",
  "src/utils/paperScoring.ts",
];
const provenance: SelectiveReportingProvenance = {
...
const report = runSelectiveReportingSimulation(
