...
export const RESEARCH_ADMINISTRATION_POLICY = Object.freeze({
  ...
  itemBankLogicalSchemaVersion: "vst-nj8-item-bank-logical-v1",
  itemBankLogicalSha256: "d94031e23515d7ed4a4d7db01d6202027874d3c9c9140cc75df93d6f58ec04f4",
  itemBankArtifactSha256: "ed058c8b87ef951c70512f89ac2ba708f18db983dd5b449b201e9b2dc97d0d47",
...
export function buildResearchAdministrationAudit(
  ...
  return {
    ...
    "項目バンク論理スキーマ": policy.itemBankLogicalSchemaVersion,
    "項目バンク論理SHA-256": policy.itemBankLogicalSha256,
    "項目バンク成果物SHA-256": policy.itemBankArtifactSha256,
