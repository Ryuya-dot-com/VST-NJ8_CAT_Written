...
import {
  runSelectionAdjustedImportanceValidation,
  type SelectionAdjustedImportancePlan,
  type SelectionAdjustedImportanceProvenance,
...
const sourcePaths = [
  "scripts/simulate-selection-adjusted-importance.ts",
  "src/utils/selectionAdjustedImportance.ts",
  "src/utils/paperScoring.ts",
];
const provenance: SelectionAdjustedImportanceProvenance = {
...
const report = runSelectionAdjustedImportanceValidation(
